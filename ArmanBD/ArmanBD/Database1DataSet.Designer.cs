...
namespace ArmanBD {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public TableRow AddTableRow(int Id, string Имя, string Фамилия, int Телефон, string _E_mail) {
        ...
        public partial class TableRow : global::System.Data.DataRow {
            ...
            public int Телефон {
                get {
                    return ((int)(this[this.tableTable.ТелефонColumn]));
                }
                set {
...
namespace ArmanBD.Database1DataSetTableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Table] WHERE (([Id] = @Original_Id) AND ((@IsNull_Имя = 1 AND [Имя] IS NULL) OR ([Имя] = @Original_Имя)) AND ((@IsNull_Фамилия = 1 AND [Фамилия] IS NULL) OR ([Фамилия] = @Original_Фамилия)) AND ([Телефон] = @Original_Телефон) AND ((@p3 = 1 AND [E-mail] IS NULL) OR ([E-mail] = @p2)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([Id], [Имя], [Фамилия], [Телефон], [E-mail]) VALUES (@" +
                "Id, @Имя, @Фамилия, @Телефон, @p1);\r\nSELECT Id, Имя, Фамилия, Телефон, [E-mail] " +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Table] SET [Id] = @Id, [Имя] = @Имя, [Фамилия] = @Фамилия, [Телефон] = @Телефон, [E-mail] = @p1 WHERE (([Id] = @Original_Id) AND ((@IsNull_Имя = 1 AND [Имя] IS NULL) OR ([Имя] = @Original_Имя)) AND ((@IsNull_Фамилия = 1 AND [Фамилия] IS NULL) OR ([Фамилия] = @Original_Фамилия)) AND ([Телефон] = @Original_Телефон) AND ((@p3 = 1 AND [E-mail] IS NULL) OR ([E-mail] = @p2)));
SELECT Id, Имя, Фамилия, Телефон, [E-mail] FROM [Table] WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ArmanBD.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Имя, Фамилия, Телефон, [E-mail] FROM dbo.[Table]";
        ...
        public virtual int Delete(int Original_Id, string Original_Имя, string Original_Фамилия, int Original_Телефон, string p2) {
            ...
            this.Adapter.DeleteCommand.Parameters[5].Value = ((int)(Original_Телефон));
            if ((p2 == null)) {
        ...
        public virtual int Insert(int Id, string Имя, string Фамилия, int Телефон, string p1) {
        ...
        public virtual int Update(int Id, string Имя, string Фамилия, int Телефон, string p1, int Original_Id, string Original_Имя, string Original_Фамилия, int Original_Телефон, string p2) {
            ...
            this.Adapter.UpdateCommand.Parameters[10].Value = ((int)(Original_Телефон));
            if ((p2 == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Имя, string Фамилия, int Телефон, string p1, int Original_Id, string Original_Имя, string Original_Фамилия, int Original_Телефон, string p2) {
            return this.Update(Original_Id, Имя, Фамилия, Телефон, p1, Original_Id, Original_Имя, Original_Фамилия, Original_Телефон, p2);
        }
    }
